...
INSERT INTO bids (id, client_id, manager_id,financier_id, date, sum, agreement_id) 
	VALUES (3, 1, 1, null, now(), 1000000, NULL);
...
INSERT INTO specialoffers (id, financier_id, sum,persent, time) VALUES (1, 1,20000, 5, 24);
